  ...
  return (
    <>
      ...
      <Typography.Paragraph>
        ข้อกำหนดและเงื่อนไขในการใช้งานฉบับนี้ ( &quot; ข้อกำหนดและเงื่อนไขฯ
        &quot; หรือ &quot; สัญญา &quot; ) เป็นข้อตกลงระหว่าง BangBow ( &quot;
        บริษัท ลิตเติ้ล บีน ซอฟท์ จำกัด &quot; หรือ &quot; เรา &quot; ) และท่าน
        ( &quot; ผู้ใช้ &quot; หรือ &quot; ท่าน &quot; )
        สัญญาฉบับนี้ได้กำหนดข้อกำหนดและเงื่อนไขทั่วไปสำหรับการใช้งาน BangBow
        ผลิตภัณฑ์หรือบริการ และการเข้าร่วมกิจกรรมที่เกี่ยวข้องกับ BangBow ใด ๆ
        ก็ตามของท่าน (เรียกรวมกันว่า &quot; เว็บไซต์ &quot; หรือ &quot; บริการ
        &quot; )
      </Typography.Paragraph>
      <Typography.Title level={5}>บัญชีผู้ใช้และสมาชิก</Typography.Title>
      <Typography.Paragraph>
      ...
      <Typography.Title level={5}>เนื้อหาของผู้ใช้งาน</Typography.Title>
      <Typography.Paragraph>
      ...
      <Typography.Title level={5}>การเรียกเก็บเงินและชำระเงิน</Typography.Title>
      <Typography.Paragraph>
        ...
        ๆ ไป เราขอสงวนสิทธิในการเปลี่ยนแปลงผลิตภัณฑ์
        บริการราคาผลิตภัณฑ์หรือบริการ และกิจกรรมที่เกี่ยวข้องกับ BangBow
        ได้ตลอดเวลา และเราขอสงวนสิทธิในการปฏิเสธคำสั่งซื้อใด ๆ
        ที่ท่านสั่งซื้อกับเรา โดยเราอาจจำกัดคำสั่งซื้อตามดุลยพินิจของเรา
        ...
        หรือหมายเลขโทรศัพท์ที่ท่านได้ให้ไว้ในขณะที่ทำการสั่งซื้อ BangBow
        นำเสนอผลิตภัณฑ์และบริการเพื่อการจำหน่าย
      ...
      <Typography.Title level={5}>นโยบายการคืนเงิน</Typography.Title>
      <Typography.Paragraph>
      ...
      <Typography.Title level={5}>บริการของบุคคลที่สาม</Typography.Title>
      <Typography.Paragraph>
        ...
        ท่านขอสละสิทธิ์โดยไม่เปลี่ยนแปลงว่าจะไม่เรียกร้องจากบริษัท ลิตเติ้ล บีน
        ซอฟท์ จำกัด ในเรื่องที่เกี่ยวข้องกับการบริการอื่นดังกล่าว บริษัท
        ลิตเติ้ล บีน ซอฟท์ จำกัด
        ...
        ถือว่าท่านได้ให้ความยินยอมโดยชัดแจ้งแก่บริษัท ลิตเติ้ล บีน ซอฟท์ จำกัด
      ...
      <Typography.Title level={5}>การสำรองข้อมูล</Typography.Title>
      <Typography.Paragraph>
      ...
      <Typography.Title level={5}>เชื่อมต่อไปยังเว็บไซต์อื่น</Typography.Title>
      <Typography.Paragraph>
      ...
      <Typography.Title level={5}>ข้อห้ามในการใช้งาน</Typography.Title>
      <Typography.Paragraph>
      ...
      <Typography.Title level={5}>สิทธิในทรัพย์สินทางปัญญา</Typography.Title>
      <Typography.Paragraph>
        สัญญานี้จะไม่เป็นการโอนสิทธิในทรัพย์สินทางปัญญาใด ๆ ที่เป็นของ บริษัท
        ลิตเติ้ล บีน ซอฟท์ จำกัด หรือบุคคลที่สามไปให้แก่ท่าน โดยสิทธิ กรรมสิทธิ์
        ...
        (ในระหว่างคู่สัญญา) กับ บริษัท ลิตเติ้ล บีน ซอฟท์ จำกัด แต่เพียงผู้เดียว
        ...
        บริษัท ลิตเติ้ล บีน ซอฟท์ จำกัด หรือผู้อนุญาตให้สิทธิในการใช้แก่บริษัท
        ลิตเติ้ล บีน ซอฟท์ จำกัด เครื่องหมายการค้า เครื่องหมายการบริการ กราฟิก
        และโลโก้
        ...
        ลิตเติ้ล บีน ซอฟท์ จำกัด หรือของบุคคลที่สาม
      </Typography.Paragraph>
      <Typography.Title level={5}>การสงวนสิทธิในการรับประกัน</Typography.Title>
      <Typography.Paragraph>
        ท่านยอมรับว่าการใช้งานเว็บไซต์ บริการ
        หรือการเข้าร่วมในกิจกรรมที่เกี่ยวข้องกับบริการของ BangBow
        ที่ทางเราได้จัดขึ้น เป็นการที่ท่านยอมรับความเสี่ยงเองแต่เพียงผู้เดียว
        ท่านยอมรับว่าบริการดังกล่าวจัดเตรียมมีให้ในรูปแบบ &quot; ตามที่เป็นอยู่
        &quot; และ &quot; ตามที่มีอยู่ &quot; เราขอปฏิเสธการรับประกันใด ๆ
        โดยชัดแจ้ง ไม่ว่าโดยชัดแจ้งหรือโดยนัย ซึ่งรวมถึงแต่ไม่จำกัดเพียง
      ...
      <Typography.Paragraph>
        ท่านยินยอมและรับทราบว่าบริษัท ลิตเติ้ล บีน ซอฟท์ จำกัด
        มิใช่สำนักงานกฎหมาย นักกฎหมาย ทนายความ หรือให้บริการคำปรึกษาทางกฎหมาย
        ดังนั้น
        เราจะไม่รับรองในความถูกต้องทางกฎหมายหรือการบังคับใช้ได้ของเอกสารต่าง ๆ
        สำหรับความต้องการที่เกี่ยวข้องกับข้อกฎหมายของท่าน
      </Typography.Paragraph>
      <Typography.Paragraph>
        นอกจากนี้ BangBow ไม่ใช่สำนักงานกฎหมายและไม่ได้ให้คำแนะนำทางด้านกฎหมาย
        บริการและ/หรือข้อมูลทั้งหมด (รวมถึงสัญญา แบบฟอร์มและเอกสารอื่น ๆ )
        ที่มีอยู่บนเว็บไซต์ของเรา [โปรดใส่ลิงก์ไปยังเว็บไซต์ BangBow]
        ...
        บริษัท ลิตเติ้ล บีน ซอฟท์ จำกัด และพนักงาน ผู้รับเหมา
      ...
      <Typography.Title level={5}>ข้อจำกัดความรับผิด</Typography.Title>
      <Typography.Paragraph>
        ตามขอบเขตสูงสุดของกฎหมายที่บังคับใช้ได้อนุญาต ไม่ว่าในกรณีใดก็ตาม บริษัท
        ลิตเติ้ล บีน ซอฟท์ จำกัด บริษัทในเครือ เจ้าหน้าที่ กรรมการ พนักงาน
        ตัวแทน คู่ค้า หรือผู้ได้รับอนุญาตของบริษัท ลิตเติ้ล บีน ซอฟท์ จำกัด
        ...
        การผิดจารีตประเพณี ประมาท หรือการใดที่บริษัท ลิตเติ้ล บีน ซอฟท์ จำกัด
        ...
        ลิตเติ้ล บีน ซอฟท์ จำกัด และบริษัทในเครือ เจ้าหน้าที่ กรรมการ พนักงาน
        ตัวแทน คู่ค้า หรือผู้ได้รับอนุญาตของบริษัท ลิตเติ้ล บีน ซอฟท์ จำกัด
        จะถูกจำกัดไว้ตามจำนวนจริงที่ท่านได้ชำระให้แก่บริษัท ลิตเติ้ล บีน ซอฟท์
        จำกัด สำหรับระยะเวลา 1
      ...
      <Typography.Title level={5}>การชดใช้ค่าเสียหาย</Typography.Title>
      <Typography.Paragraph>
        ท่านตกลงที่จะชดใช้ค่าเสียหายและปกป้อง บริษัท ลิตเติ้ล บีน ซอฟท์ จำกัด
        และ บริษัทในเครือ กรรมการ เจ้าหน้าที่ พนักงาน
        และตัวแทนจากหรือต่อความรับผิด ความสูญเสีย ความเสียหายหรือค่าใช้จ่าย
        รวมถึงค่าทนายความที่เหมาะสม ที่เกี่ยวเนื่องหรือเกิดขึ้นจากข้อกล่าวหา
        ข้อเรียกร้อง การกระทำ ข้อพิพาท
        ...
        ลิตเติ้ล บีน ซอฟท์ จำกัด หรือการกระทำอันมิชอบโดยเจตนาใด ๆ ของท่าน
      </Typography.Paragraph>
      <Typography.Title level={5}>
      ...
      <Typography.Title level={5}>เนื้อหาและการโพสต์</Typography.Title>
      <Typography.Paragraph>
        ...
        หรือวิธีการอื่นใดโดยไม่ได้รับอนุญาตที่ชัดแจ้งจากบริษัท ลิตเติ้ล บีน
        ซอฟท์ จำกัด จะถือเป็นสิ่งต้องห้ามในการกระทำ
      </Typography.Paragraph>
      <Typography.Paragraph>
        ...
        ในการนำส่งหรืออัปโหลดไฟล์บนเว็บไซต์ถือว่าท่านได้ยินยอมให้บริษัท ลิตเติ้ล
        บีน ซอฟท์ จำกัด ในการนำออกซึ่งไฟล์ใด ๆ ในเวลาใด ๆ ก็ได้
      </Typography.Paragraph>
      <Typography.Title level={5}>การโอนสิทธิ</Typography.Title>
      <Typography.Paragraph>
      ...
      <Typography.Title level={5}>การเปลี่ยนแปลงและการแก้ไข</Typography.Title>
      <Typography.Paragraph>
      ...
      <Typography.Title level={5}>การยอมรับในข้อตกลง</Typography.Title>
      <Typography.Paragraph>
      ...
      <Typography.Title level={5}>ติดต่อเรา</Typography.Title>
      <Typography.Paragraph>
        2 อาคารมาริโกลด์ ทาวเวอร์ สุวรรณภูมิ ชั้น 2 ห้องเลขที่ 1207 ซอยลาดกระบัง
        1 ถนนอ่อนนุช-ลาดกระบัง ลาดกระบัง ลาดกระบัง กรุงเทพมหานคร 10520
      </Typography.Paragraph>
      ...
      <Typography.Paragraph>
        เว็บไซต์ https://littlebeansoft.com
      </Typography.Paragraph>
      ...
      <Typography.Paragraph>
        เอกสารฉบับนี้ปรับปรุงล่าสุดเมื่อวันที่ 3 มกราคม พ.ศ. 2566
        (เป็นข้อความตัวอย่างก่อนพิจารณาแก้ไข )
      </Typography.Paragraph>
    </>
  )
}
