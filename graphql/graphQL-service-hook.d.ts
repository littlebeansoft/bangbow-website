...
export interface APIPayloadResponseWithPagination<T>
  extends APIPayloadResponse<T> {
  pagination: Pagination
}

export interface APIPayloadResponseForProductRelocation<T>
  extends APIPayloadResponseWithPagination<T> {
  verified: number
}
